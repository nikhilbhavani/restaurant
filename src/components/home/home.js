...
export default function home(){
    ...
    para1.textContent='Step into a world of culinary delights at The Rocket League, where every meal is a journey of taste and creativity. From our signature dishes crafted with the freshest ingredients to indulgent desserts that satisfy your sweet tooth, we’ve curated a menu that has something for everyone. Let your appetite guide you and explore the possibilities of what we have to offer.';
    ...
    para3.textContent='Explore our website to check out our menu. Hungry now? Order online and bring the magic of The Rocket League straight to your table.';
    const descrpt=document.createElement('div');
    descrpt.className='home-description';
    descrpt.append(para1,para2,para3);
    container.append(title,subtitle,descrpt);
    return container;
}